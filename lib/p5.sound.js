...
oscillator = function () {
  ...
  /**
   *  Start an oscillator. Accepts two optional parameters.
   *  The first is a volume between 0.0 and 1.0 (default 0.5).
   *  The second determines how long (in seconds from now)
   *  until the oscillator starts.
   *
   *  @method  start
   ...
   */
  p5.Oscillator.prototype.start = function (amp, time, f) {
    if (this.started) {
      var now = p5sound.audiocontext.currentTime;
      this.stop(now);
    }
